...
# extraction returns in ~2s; the cap exists for the heavy tail — a very large
# photo or PDF can take Gemini 12s+ to process (observed in production as
# 504 DEADLINE_EXCEEDED at the old 12s cap), and a slow success beats a hard
# failure. Override with GEMINI_TIMEOUT_MS (do not set below 10000).
